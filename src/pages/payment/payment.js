...
import apple from "../../components/payments/apple";
import google from "../../components/payments/google";
  ...
  try {
    ...
    return El({
      ...
      children: [
        ...
        paymentCard(wallet(), "My Wallet", totalPricePayment),
        paymentCard(paypal(), "Pay Pal", totalPricePayment),
        paymentCard(google(), "Google", totalPricePayment),
        paymentCard(apple(), "Apple Pay", totalPricePayment),
        paymentCard(
          mastercard(),
          ".... .... .... .... 4679",
          totalPricePayment
